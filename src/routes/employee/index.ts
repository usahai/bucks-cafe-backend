...
import type { AddEmployee, DeleteEmployee, UpdateEmployee } from '../../models/employee'
...
async function addNewEmployee(req: Request<unknown, unknown, AddEmployee>, res: Response) {
  try {
...
async function updateEmployee(req: Request<unknown, unknown, UpdateEmployee>, res: Response) {
  try {
    console.log('[EMP] body:', req.body)
    // Create connection
    await (await promiseConn).beginTransaction
...
async function deleteEmployee(req: Request<unknown, unknown, DeleteEmployee>, res: Response) {
  try {
